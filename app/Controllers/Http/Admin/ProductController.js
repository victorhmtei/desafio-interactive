...
class ProductController {
  ...
  async store ({ request, response, transform }) {
    ...
    try {
      ...
      response.status(400).send({message: 'Nao foi possivel criar o produto neste momento'})
  ...
  async update ({ params: {id}, request, response , transform}) {
    ...
    try {
      ...
      return response.status(400).send({message: 'Não foi possivel atualizar o produto selecionado'})
  ...
  async destroy ({ params:{id}, request, response }) {
    ...
    try {
      ...
      return response.status(500).send({message: 'Não foi possivel deletar o produto selecionado'})
    }
  }
}
